...
def main(input_filepath, output_filepath,delete_files):
    ...
    for file in os.scandir(image_input_path):
        __process_image(file,image_input_path,warped_output_path,image_output_path)
        __process_crossword(file,crossword_input_path,crossword_output_path)
...
def __process_image(file,image_input_path,warped_output_path,image_output_path):
